    ...
    <div class="views-amount">
        ...
        <div class="views-amount__svg">
            <svg width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M9.00004 2.17584C7.03683 2.17584 5.43958 3.7731 5.43958 5.7363C5.43958 7.6995 7.03683 9.29676 9.00004 9.29676C10.9632 9.29676 12.5605 7.6995 12.5605 5.7363C12.5605 3.7731 10.9632 2.17584 9.00004 2.17584ZM9.00004 8.10992C7.69116 8.10992 6.62642 7.04514 6.62642 5.7363C6.62642 4.42747 7.6912 3.36269 9.00004 3.36269C10.3089 3.36269 11.3737 4.42747 11.3737 5.7363C11.3737 7.04514 10.3089 8.10992 9.00004 8.10992Z" fill="#8D8D8D"/>
            </svg>
        </div>
    </div>
</template>
